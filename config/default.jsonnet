{
  ...
  gitlab_runner_chart_version: '0.91.0',
  ...
  ingress_controller: 'traefik', // Which ingress controller to use (see deploy/ingress-controller/templates for the available ones)
